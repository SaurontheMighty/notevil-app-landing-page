...
<div class="recommendation-container">
    <div class="recommended-apps">
        <span class="recommended-app" style="--index: 0; --offset-x: 100%; --offset-y: 0px;">
            <img class="recommended-icon" src="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/10/9f/1b/109f1b0c-4c8d-2b13-67ed-5c5d73c5b7c6/Primary-0-0-1x_U007epad-0-1-0-sRGB-85-220.png/460x0w.webp" alt="Not Evil Sudoku icon">
        </span>
    </div>
    <div class="recommendation-text">
        <p><strong>Not Evil Sudoku:</strong> "As if Apple made a sudoku app".</p>
        <ul>
            <li>No Ads and so no tracking</li>
            <li>No game features are behind a paywall</li>
            <li>One game a day, the Daily Puzzle unless you buy the 4.99 USD purchase</li>
        </ul>
    </div>
</div>
...
<div class="recommendation-container">
    ...
    <div class="recommendation-text">
        <p><strong>Good Sudoku: Well designed but a more opinionated design</strong>
        <ul>
            <li>Video ads between puzzles</li>
            <li>Harder difficulties are locked unless you buy the 4.99 USD purchase</li>
        </ul></p>
    </div>
</div>
 -->
